		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Product Allocation Planning Data",
									"targetURL": "#commngprdalldatmngpalplndata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commngprdalldatmngpalplndata-display": {
								"semanticObject": "commngprdalldatmngpalplndata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mng.prd.all.dat.mngpalplndata",
									"url": sap.ui.require.toUrl("com/mng/prd/all/dat/mngpalplndata")
								}
							}
						}
					}
